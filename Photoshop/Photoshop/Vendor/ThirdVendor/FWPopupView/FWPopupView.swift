...
open class FWPopupViewProperty: NSObject {
    ...
    /// 标题字体大小
    @objc open var titleFontSize: CGFloat           = 14
    /// 标题文字颜色
    @objc open var titleColor: UIColor              = kPV_RGBA(r: 255, g: 255, b: 255, a: 1)
    
    /// 按钮字体大小
    @objc open var buttonFontSize: CGFloat          = 13
    /// 按钮高度
    @objc open var buttonHeight: CGFloat            = 40
    // 按钮显示背景图
    @objc open var buttonImageBackGround: Bool           = false
    /// 普通按钮文字颜色
    @objc open var itemNormalColor: UIColor         = kPV_RGBA(r: 255, g: 255, b: 255, a: 0.8)
    /// 高亮按钮文字颜色
    @objc open var itemHighlightColor: UIColor      = kPV_RGBA(r: 255, g: 255, b: 255, a: 1)
    /// 选中按钮文字颜色
    @objc open var itemPressedColor: UIColor        = kPV_RGBA(r: 67, g: 37, b: 114, a: 1)
    ...
    /// 弹窗的最大高度，0：表示不限制
    @objc open var popupViewMaxHeight: CGFloat      = UIScreen.main.bounds.height * CGFloat(0.5)
