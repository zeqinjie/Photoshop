...
public class ZQRadioButton: UIView {
	
	/// The view used for the rippling effect.
	@IBInspectable private let waveCircle   = UIView()
	/// The view used for the filling.
	@IBInspectable private let circle       = UIView()
	/// The view used for the margin.
	@IBInspectable private let innerCircle  = UIView()
